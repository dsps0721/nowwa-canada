...
const translations = {
  en: {
    ...
    // Hero
    'hero.tag': 'OFFICIAL CANADA MASTER FRANCHISE',
    'hero.title.1': 'FRESH FRUIT',
    'hero.title.2': 'COFFEE',
    'hero.title.3': 'IN CANADA',
    'hero.subtitle': 'Low Sugar · Healthy · Nowwa Coffee Has Arrived',
    'hero.desc': 'Bringing the world\'s leading fruit coffee brand to Canada. We are the official master franchise, inviting you to join the healthy coffee revolution.',
    ...
    'products.cheese.name': 'Supermodel Cheese Latte',
    ...
    'why.item3.title': 'Mature Model, Proven Success',
    'why.item3.desc': 'Leveraging global scale and standardized management systems to make entrepreneurship simpler and success traceable.',
    ...
    'franchise.form.firstName': 'First Name',
    'franchise.form.lastName': 'Last Name',
    'franchise.form.phone': 'Phone Number',
    'franchise.form.optional': '(Optional)',
  ...
  zh: {
    ...
    'hero.title.2': '登陆',
    'hero.title.3': '加拿大',
    'hero.subtitle': '低糖 · 健康 · 挪瓦咖啡正式进驻',
    'hero.desc': '将全球领先的果咖品牌带入加拿大。作为官方总代理，我们诚邀您加入这场健康咖啡革命，抢占市场先机。',
    'hero.cta': '成为城市合伙人',
    ...
    'why.item3.title': '成熟商业模式，复制成功经验',
    'why.item3.desc': '依托全球万店规模，共享标准化管理体系，让创业更简单，让成功有迹可循。',
    'why.cta': '立即咨询加盟政策',
    ...
    'franchise.form.firstName': '名',
    'franchise.form.lastName': '姓',
    'franchise.form.phone': '电话号码',
    'franchise.form.optional': '(可选)',
